...
export const lifecycleStages: LifecycleStage[] = [
  {
    ...
    note: "A small safe room, a familiar carrier, and the first pages of Momo's log.",
  },
  {
    id: "young-adult",
    label: "Young / adult",
  ...
  },
  {
    ...
    note: "No chapter is skipped. Time passes here, and the routines built earlier become Momo's ordinary life.",
  },
  {
    id: "senior",
    label: "Senior",
...
export const chapters: Chapter[] = [
  {
    ...
    homeCue: "The carrier is open. Momo is under the bed.",
    hotspot: { x: 75, y: 70 },
    implemented: true,
  },
  {
    ...
    homeCue: "A hand pauses beside the chair. Momo decides whether to return.",
    hotspot: { x: 25, y: 56 },
    implemented: false,
  },
  {
  ...
  },
  {
    ...
    question: "What is Momo saying once the easy signals run out?",
    part: 2,
    partTitle: "Learn to Read Her",
    stage: "kitten",
    momoAge: "About 16 weeks",
    homeCue: "Momo waits at the door. One sound is not enough to explain why.",
    hotspot: { x: 87, y: 45 },
    implemented: false,
  },
  {
    ...
    question: "What is Momo trying to tell us by scratching the sofa?",
    part: 2,
    partTitle: "Learn to Read Her",
    stage: "young-adult",
  ...
  },
  {
    ...
    question: "What might Momo be hiding, and how would we notice?",
    part: 3,
    partTitle: "Keep Her Well",
    stage: "young-adult",
  ...
  },
  {
    ...
    homeCue: "A ramp reaches the sofa Momo once jumped onto without thinking.",
    hotspot: { x: 44, y: 70 },
    implemented: false,
  },
  {
