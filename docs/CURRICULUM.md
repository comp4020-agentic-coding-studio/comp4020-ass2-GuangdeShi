...
| 10 | 10 | IV — Change With Her | The Aging Cat | Senior, ~13 years | What does "keeping her well" mean when wellness itself is changing? | Reduced activity/jumping as a possible joint-pain signal, not just "getting old"; the four named budgets of care (financial, time, emotional, physical) as the organising frame for scaling senior care to a household's real capacity; reapplying Ch6's baseline method to slow, gradual change and Ch9's acute-pain tool correctly scoped away from chronic presentations | Recognise aging-related physical change and adapt routine/environment/vet cadence, scaled to the caregiver's real capacity ("budgets of care") | Eleven-plus years after Chapter 9, a housemate dismisses Momo's reduced counter-jumping as "just getting old" with no examined baseline | A senior cat avoiding stairs and having ground-floor-only litter box accidents for six weeks, tested against a household that tries (and is corrected for) applying Chapter 9's acute-pain tool to a chronic presentation | S15, S20, S21 (see `docs/SOURCES.md`) | CONTENT DRAFTED — see `docs/chapters/chapter-10.md`. Depends on Ch6, Ch7, Ch8 (CH10-03 directly reapplies the indoor/outdoor lifestyle decision, `CH8-01`/`CH8-03`, to Momo's aging), Ch9. Deliberate large time skip (~18 months to ~13 years) opens Part IV (see chapter file's "Approved framing note" and Open questions). |
| 11 | 11 | IV — Change With Her | When Her Mind Changes | Senior, ~15 years | Is this just "getting old," or something I need to act on? | Cognitive-dysfunction sign list and its rule-out-first diagnostic process; the deliberate second callback to Ch3's medical-first reasoning, showing several signs overlap with already-taught conditions (Ch9 dental, Ch10 joint pain); owner-support suggestions rescaled to Ch10's budgets of care; Ch6's two failure modes reapplied as normalisation drift vs. premature self-diagnosis | Reapply Ch3's medical-first reasoning to a new life stage: recognise cognitive-dysfunction signs without self-diagnosing | A few years after Chapter 10, Momo yowls most nights and stares blankly at walls; a housemate says "she's just losing her mind" and starts shopping for a cognitive-support supplement online | A disoriented, altered-sleep-cycle cat with one house-soiling accident and clean dental/mobility checks, tested against a household that must report the full pattern rather than concluding cognitive dysfunction from partial checks alone | S25, S15 (see `docs/SOURCES.md`) | CONTENT DRAFTED — see `docs/chapters/chapter-11.md`. Depends on Ch3 (deliberate reasoning callback, approved), Ch6, Ch9, Ch10. |
| 12 | 12 | IV — Change With Her | Deciding Together | ~19 years, entering her twentieth year | How do we decide, together, what care looks like now? | HRQOL/frailty as a real, trackable concept; the five-step hospice/palliative care-plan process; a deliberate decision not to teach any specific QOL scoring tool, redirecting instead to logged observations; the "unit of care" concept combined with Ch10's budgets of care; Ch7's owner-reports-facts principle and Ch11's two failure modes reapplied as the course's final capstone synthesis | Participate in a caregiver-inclusive quality-of-life conversation and decision process, understood as a partnership, not a solo checklist (course capstone) | Momo's vet raises "quality of life going forward" after a chronic-condition diagnosis; a housemate finds an online quiz that produces a numeric score | A shared family cat with several relatives in disagreement, tested against a household tempted to let a visiting-frequency hierarchy or an online score settle the conversation instead of the household's own logged observations and budgets | S16, S15 (see `docs/SOURCES.md`) | CONTENT DRAFTED — see `docs/chapters/chapter-12.md`. Depends on Ch1, Ch6, Ch7, Ch10, Ch11. Course capstone; deliberately does not depict a specific end-of-life outcome for Momo (see chapter file's Open questions). |
